...
- (void)test_diff_mainTest {
  ...
  XCTAssertTrue(((dmp.Diff_Timeout * 4) > (endTime - startTime)), @"Test that we didn't take forever (be forgiving). dmp.Diff_Timeout = %f, (endTime - startTime) = %f", dmp.Diff_Timeout, (endTime - startTime));
  dmp.Diff_Timeout = 0;
